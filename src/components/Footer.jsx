const Footer = () => {
    ...
    return (
        <>
            <footer className="mt-20 mb-10 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 shadow-2xl">
                <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
                <div className="sm:col-span-2">
                    <a href="/" aria-label="Go home" title="Company" className="inline-flex items-center">
                        <img src="./src/assets/img/corpCap.svg" alt="logo company" className="w-20" fill="none" />
                    </a>
                    ...
                    <div className="flex">
                        ...
                        <a href="tel:+549-(11)-6212-8806" aria-label="Our phone" title="Our phone" className="transition-colors duration-300 text-deep-purple-accent-400 hover:text-deep-purple-800">+549-(11)-6212-8806</a>
                        </div>
                        <div className="flex">
                            <p className="mr-1 text-gray-800 font-saiyan ">Email:</p>
                            <a href="mailto:info@lorem.mail" aria-label="Our email" title="Our email" className="transition-colors duration-300 text-deep-purple-accent-400 hover:text-deep-purple-800">MartDesing@gmail.com</a>
                        </div>
                        <div className="flex">
                    ...
                    <div>
                        ...
                        <div className="flex p-2 mt-1">
                            ...
                            <p>Te invitamos a conocer nuestros sitios en donde podras tener contacto personalizado con nosotros.</p>
                    </div>
                </div>
